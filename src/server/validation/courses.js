...
module.exports = function validateCoursesInput(data) {
  ...
  if (subject && teacher) {
    ...
    errors.teacher = 'Teacher & subject both details is required';
    errors.subject = 'Teacher & subject both details is required';
  }

  return {
    errors,
    isValid: isEmpty(errors.teacher) && isEmpty(errors.subject)
  };
};
